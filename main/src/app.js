...
(0, typeorm_1.createConnection)().then(function (db) {
    ...
    amqp.connect('amqps://knnyusev:EFkuRlQ9SrVGjc1WwKI1OGDvYsDy1GHk@whale.rmq.cloudamqp.com/knnyusev', function (error0, connection) {
        if (error0) {
            throw error0;
        }
        connection.createChannel(function (error1, channel) {
            ...
            channel.consume('update_product', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var eventProduct, product;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            channel.consume('delete_product', function (msg) { return __awaiter(void 0, void 0, void 0, function () {
                var admin_id;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
